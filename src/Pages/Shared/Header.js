...
const Header = () => {
    ...
    return (
        <div className="px-4 mb-12 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 sticky top-0 bg-white shadow-2xl text-slate-700  z-50 h-fit">
